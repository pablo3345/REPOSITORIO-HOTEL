...
class HabitacionAdmin(admin.ModelAdmin):
    ...
    list_display = ("nombre_numero", "capacidad", "precio_por_noche","camita_bebe", "posee_heladera","posee_aire_acondicionado" ,"posee_calefaccion", "posee_ventana", "posee_cama_matrimonial", "posee_televisor", "posee_wifi",
                    "jacuzzi","posee_microondas","check_out_lates", "otro_dato","estado", "created", "updated")
